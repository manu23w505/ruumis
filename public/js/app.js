...
async function cargarHeaderDinamico() {
    try {
        ...
        if (config) {
            ...
            const svgPorDefecto = `
                <svg width="80" height="40" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg" style="background: transparent;">
                ...
                if (archivoLogo && (archivoLogo.endsWith('.jpg') || archivoLogo.endsWith('.jpeg') || archivoLogo.endsWith('.png') || archivoLogo.endsWith('.webp'))) {
                    ...
                    elemento.outerHTML = `
                        <img 
                            ...
                            alt="Logotipo" 
                            style="width: 80px; height: 40px; object-fit: contain; background: transparent; display: inline-block; vertical-align: middle;"
                        />`;
                } 
