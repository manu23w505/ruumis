...
async function cargarHeaderDinamico() {
    try {
        ...
        if (config) {
            ...
            const svgPorDefecto = `
                <svg width="50" height="60" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg" style="background: transparent;">
                ...
                if (archivoLogo && (archivoLogo.endsWith('.jpg') || archivoLogo.endsWith('.jpeg') || archivoLogo.endsWith('.png') || archivoLogo.endsWith('.webp'))) {
                    ...
                    elemento.outerHTML = `
                        <img 
                            ...
                            alt="Logotipo" 
                            style="width: 50px; height: 60px; object-fit: contain; background: transparent; display: inline-block; vertical-align: middle;"
                        />`;
                } 
